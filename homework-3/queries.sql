...
SELECT customers.company_name, employees.first_name, employees.last_name FROM customers
...
JOIN suppliers ON products.supplier_id=suppliers.supplier_id JOIN categories ON products.category_id=categories.category_id
